...
public class MeshPathFinderSteeringBehavior : SteeringBehavior, IGizmos, ITargeter
{
    ...
    /// <summary>
    /// Current path generated by the pathfinder.
    /// </summary>
    ...
    private void UpdatePath(Vector2 newTargetPosition)
    {
        ...
        CurrentPath.UpdatePathData(newPath);
    }
    ...
    private void Awake()
    {
        ...
        // Unity life cycle.
        CurrentPath = new GameObject().AddComponent<Path>();
        ...
        // here.
        pathFollowingSteeringBehavior.FollowPath = CurrentPath;
    }
