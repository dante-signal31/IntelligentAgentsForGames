...
{
/// <summary>
/// <p>Script to offer a Pursuit-steering behavior.</p>
/// <p>To pursue another agent, it won't be enough to go to its current position. If that
/// agent displaces, then we will only follow its trail. Instead, 
/// the pursuer must predict where the chased agent will be and aim to that position.</p>
/// </summary>
public class PursuitSteeringBehavior : SteeringBehavior
{
    ...
    /// <summary>
    /// Radians from the forward vector inside which we consider an object is in
    /// front of us.
    /// </summary>
    ...
    /// <summary>
    /// Radians from the forward vector inside which we consider an object is going
    /// toward us.
    /// </summary>
    ...
    /// <summary>
    /// Whether the target is coming to us.
    /// </summary>
    /// <param name="args">Our current data.</param>
    /// <returns>True if the target has a velocity vector that is going toward us.</returns>
